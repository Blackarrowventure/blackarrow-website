...
POSTS = {
    ...
    'buy-3d-printer-saudi-arabia-price-guide': {
        ...
        'body': '''
          ...
          <h2>تشتري لمدرسة أو ورشة عمل أو شركة؟</h2>
          <p>إذا كنت تجهّز فصلاً دراسياً أو مساحة صنع أو خط إنتاج بدلاً من شراء طابعة واحدة لنفسك، اطلب عرض سعر للأعمال بدلاً من شراء الوحدات واحدة تلو الأخرى &mdash; يمكننا تسعير عدة طابعات وفلمنت وإكسسوارات معاً.</p>

          <div class="b3d-article__cta">
            <p>احصل على عرض سعر لمشروعك أو شركتك</p>
            <a href="/contact.html?service=3d" class="btn btn-primary">اطلب عرض سعر</a>
          </div>
