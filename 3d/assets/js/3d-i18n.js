...
(function () {
  ...
  var DICT = {
    en: {
      ...
      hub_hero_p: 'Shop reliable 3D printers, filaments and accessories, or request professional printing, CAD modelling, prototyping, maintenance and training.',
      hub_explore_shop: 'Shop 3D Printers',
      hub_request_quote: 'Request a Printing Quote',
      ...
      hub_svc_overline: 'Beyond Retail',
      hub_svc_h2: 'Professional 3D Services',
      hub_svc_sub: 'Beyond retail — printing, design and support work carried out by our team',
      svc_request_quote: 'Request a Quote',
      svc_whatsapp: 'WhatsApp Us',
      svc_printing_title: '3D Printing Service',
      svc_printing_desc: 'Send us a file and we will print it for you.',
      svc_prototype_title: 'Rapid Prototyping',
      svc_prototype_desc: 'Fast turnarounds for testing form, fit and function.',
      svc_cad_title: 'CAD Modelling',
      svc_cad_desc: 'Turn an idea, sketch or sample part into a 3D model.',
      svc_scan_title: '3D Scanning',
      svc_scan_desc: 'Digitize an existing physical part or object.',
      svc_custom_title: 'Customized Part Production',
      svc_custom_desc: 'One-off or custom-spec parts made to your requirements.',
      svc_batch_title: 'Small-Batch Manufacturing',
      svc_batch_desc: 'Short production runs without tooling costs.',
      svc_install_title: 'Printer Installation',
      svc_install_desc: 'Setup and calibration for a printer you already own.',
      svc_maintenance_title: 'Maintenance & Repairs',
      svc_maintenance_desc: 'Servicing and repair for desktop and industrial printers.',
      svc_support_title: 'Technical Support',
      svc_support_desc: 'Help with a print, material or machine issue.',
      svc_training_title: 'Training & Consultancy',
      svc_training_desc: 'Guidance on choosing and running the right equipment.',

      hub_biz_h2: 'For Businesses, Schools & Government',
      hub_biz_p: 'Workshops, schools, universities and government organizations can request equipment, consumables or printing services as an institutional order — one point of contact, one quotation.',
      hub_biz_cta: 'Request an Institutional Quote',
      ...
      faq_a1: 'Yes — use "Request a Printing Quote" above or WhatsApp us, and we will follow up directly.',
      ...
      faq_q3: 'Can I request custom 3D printing, prototyping or CAD work?',
      faq_a3: 'Yes — see Professional 3D Services above, or contact us with your requirements.',
      faq_q4: 'Do you offer installation, maintenance or training?',
      faq_a4: 'Yes — printer installation, maintenance/repairs, and training/consultancy are listed under Professional 3D Services.',
      ...
      js_request_quote_pd: 'Request Business Quotation',
    ...
    ar: {
      ...
      hub_hero_p: 'تسوّق طابعات ثلاثية الأبعاد وفلامنت وملحقات موثوقة، أو اطلب خدمات الطباعة الاحترافية والتصميم بالحاسوب (CAD) والنماذج الأولية والصيانة والتدريب.',
      hub_explore_shop: 'تسوّق الطابعات ثلاثية الأبعاد',
      hub_request_quote: 'اطلب عرض سعر للطباعة',
      ...
      hub_svc_overline: 'أكثر من مجرد بيع',
      hub_svc_h2: 'خدمات الطباعة ثلاثية الأبعاد الاحترافية',
      hub_svc_sub: 'أكثر من مجرد بيع — طباعة وتصميم ودعم يقوم بها فريقنا',
      svc_request_quote: 'اطلب عرض سعر',
      svc_whatsapp: 'راسلنا عبر واتساب',
      svc_printing_title: 'خدمة الطباعة ثلاثية الأبعاد',
      svc_printing_desc: 'أرسل لنا الملف وسنقوم بطباعته لك.',
      svc_prototype_title: 'النماذج الأولية السريعة',
      svc_prototype_desc: 'تنفيذ سريع لاختبار الشكل والتوافق والوظيفة.',
      svc_cad_title: 'التصميم بالحاسوب (CAD)',
      svc_cad_desc: 'حوّل فكرة أو رسمًا أو عينة إلى نموذج ثلاثي الأبعاد.',
      svc_scan_title: 'المسح ثلاثي الأبعاد',
      svc_scan_desc: 'رقمنة قطعة أو جسم مادي موجود بالفعل.',
      svc_custom_title: 'تصنيع قطع مخصصة',
      svc_custom_desc: 'قطع فردية أو بمواصفات خاصة حسب متطلباتك.',
      svc_batch_title: 'التصنيع بدفعات صغيرة',
      svc_batch_desc: 'إنتاج بكميات محدودة دون تكاليف قوالب.',
      svc_install_title: 'تركيب الطابعات',
      svc_install_desc: 'إعداد ومعايرة لطابعة تملكها بالفعل.',
      svc_maintenance_title: 'الصيانة والإصلاح',
      svc_maintenance_desc: 'صيانة وإصلاح للطابعات المكتبية والصناعية.',
      svc_support_title: 'الدعم الفني',
      svc_support_desc: 'مساعدة في مشكلة طباعة أو مادة أو جهاز.',
      svc_training_title: 'التدريب والاستشارات',
      svc_training_desc: 'إرشاد حول اختيار وتشغيل المعدات المناسبة.',

      hub_biz_h2: 'للشركات والمدارس والجهات الحكومية',
      hub_biz_p: 'يمكن لورش العمل والمدارس والجامعات والجهات الحكومية طلب المعدات أو المستهلكات أو خدمات الطباعة كطلب مؤسسي — جهة اتصال واحدة وعرض سعر واحد.',
      hub_biz_cta: 'اطلب عرض سعر مؤسسي',
      ...
      faq_a1: 'نعم — استخدم "اطلب عرض سعر للطباعة" أعلاه أو راسلنا عبر واتساب وسنتابع معك مباشرة.',
      ...
      faq_q3: 'هل يمكنني طلب طباعة أو نماذج أولية أو تصميم CAD مخصص؟',
      faq_a3: 'نعم — راجع خدمات الطباعة ثلاثية الأبعاد الاحترافية أعلاه، أو تواصل معنا بمتطلباتك.',
      faq_q4: 'هل تقدمون التركيب أو الصيانة أو التدريب؟',
      faq_a4: 'نعم — تركيب الطابعات والصيانة/الإصلاح والتدريب/الاستشارات مدرجة ضمن الخدمات الاحترافية.',
      ...
      js_request_quote_pd: 'اطلب عرض سعر للشركات',
