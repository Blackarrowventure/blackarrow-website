...
(function () {
  ...
  var DICT = {
    en: {
      ...
      pm_bank_notready: 'Bank account details are being finalized — please use the button below to request them, or choose Cash on Delivery.',
    ...
    ar: {
      ...
      pm_bank_notready: 'بيانات الحساب البنكي قيد الإعداد — استخدم الزر أدناه لطلبها، أو اختر الدفع عند الاستلام.',
