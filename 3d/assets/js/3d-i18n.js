...
(function () {
  ...
  var DICT = {
    en: {
      ...
      hub_hero_p: 'Desktop and industrial FDM printers, resin systems, and print materials for Saudi Arabia — sourced, specified, and supported with the same reliability standard as our critical infrastructure work, with nationwide delivery to Riyadh, Jeddah, Dammam and beyond.',
    ...
    ar: {
      ...
      hub_hero_p: 'طابعات FDM للاستخدام المكتبي والصناعي، وأنظمة الراتنج، ومواد الطباعة لجميع مناطق المملكة العربية السعودية — يتم اختيارها وتوريدها ودعمها بنفس معايير الموثوقية المعتمدة في أعمالنا للبنية التحتية الحرجة، مع توصيل لجميع المدن: الرياض وجدة والدمام وغيرها.',
