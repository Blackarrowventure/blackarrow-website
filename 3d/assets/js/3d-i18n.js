...
(function () {
  ...
  var DICT = {
    en: {
      ...
      hub_hero_p: 'Shop 3D printers, filament and accessories, or send us a design and we will print it for you. Nationwide delivery across Saudi Arabia.',
      ...
      faq_a8: 'Yes, only in the following cases: a manufacturing defect, receiving the wrong product, or damage during shipping. Returns are not accepted for a change of mind. See our Return & Exchange Policy for details.',
    ...
    ar: {
      ...
      hub_hero_p: 'تسوّق الطابعات ثلاثية الأبعاد والفلامنت والإكسسوارات، أو أرسل لنا تصميمك ونطبعه لك. توصيل لجميع مناطق المملكة.',
      ...
      faq_a8: 'نعم، فقط في الحالات التالية: عيب تصنيع، أو استلام منتج خاطئ، أو ضرر أثناء الشحن. لا يُقبل الإرجاع لمجرد تغيير الرأي. راجع سياسة الاسترجاع والاستبدال لمزيد من التفاصيل.',
