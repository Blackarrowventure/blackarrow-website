...
(function () {
  ...
  var DICT = {
    en: {
      ...
      hub_hero_h1_a: '3D Printers and Custom 3D Printing',
      hub_hero_h1_b: 'in Saudi Arabia',
      hub_hero_p: 'Shop Bambu Lab, Creality, Elegoo and more, or send us your model and we will print it for you. Nationwide delivery across Saudi Arabia.',
      footer_shipping: 'Shipping Policy',
      footer_service: '3D Printing Service',
      journey_b_link: 'How our printing service works',
      cmp_help_h2: 'What to compare when choosing a 3D printer',
      cmp_help_p: 'Use the compare button on any printer in the shop to see printers side by side. These are the specifications that matter most:',
      cmp_help_1: 'Build volume: the largest part you can print in one piece.',
      cmp_help_2: 'Enclosure: enclosed printers keep the print chamber stable and suit more materials.',
      cmp_help_3: 'Maximum hot end temperature: sets which materials the printer can handle.',
      cmp_help_4: 'Multicolor system: filament changers such as AMS Lite, CFS Lite or CANVAS, or independent toolheads.',
      cmp_help_5: 'Print speed and acceleration.',
      cmp_help_6: 'Supported filament and material compatibility.',
      cmp_help_7: 'Price in Saudi riyals (SAR).',
      cmp_help_link1: 'Browse 3D printers',
      cmp_help_link2: 'Read: Bambu Lab A1 vs A1 mini vs A2L',
      journey_b_cta2: 'Browse 3D Artwork',
      journey_b_6: 'Request a quotation',
      journey_b_5: 'Decor and artwork',
      journey_b_4: 'Prototypes',
      journey_b_3: 'Custom gifts',
      journey_b_2: 'Send a MakerWorld link',
      journey_b_1: 'Send your design file',
      journey_b_p: 'Tell us what you need on WhatsApp. All details are confirmed with you before production.',
      journey_b_h3: 'Get Something 3D Printed',
      journey_a_cta2: 'Browse all products',
      journey_a_5: 'After-sales support',
      journey_a_4: 'Business quotations',
      journey_a_3: 'Accessories',
      journey_a_2: 'Filament',
      journey_a_1: '3D printers',
      journey_a_p: 'Printers, filament and accessories from Bambu Lab, Creality, Elegoo, Anycubic and Snapmaker.',
      journey_a_h3: 'Buy 3D Printing Equipment',
      journeys_h2: 'How can we help you?',
      hub_explore_shop: 'Shop 3D Printers',
      hub_ask_question: 'Get a 3D Printing Quote',
      ...
      faq_a1: 'Yes. Use "Get a 3D Printing Quote" above or WhatsApp us, and we will follow up directly.',
      faq_q2: 'What payment methods are available?',
      faq_a2: 'Cash on Delivery, Bank Transfer and Business Quotation are available.',
      faq_q3: 'Are the products the same as shown in the images?',
      faq_a3: 'Printers, filament and accessories are the manufacturer\'s products, as shown and described on each product page. Our 3D printed items (artwork, keychains, gifts) are made by 3D printing, so you may notice slight layer lines or minor variations in colour or texture. This is normal and reflects the printing process, not a defect.',
      faq_q4: 'Are the products worth the price?',
      faq_a4: 'Printers, filament and accessories are standard manufacturer products, priced in SAR, and you can compare models in the shop. Our 3D printed items are unique designs produced in-house, often made to order, and each piece goes through several stages of design and production.',
      faq_q5: 'How long does it take to prepare an order?',
      faq_a5: '3D printed items are typically prepared within 3 to 5 business days, as most are made to order. For printers, filament and accessories, availability (including pre-order status) is shown on each product page.',
      ...
      faq_a8: 'Unused printers and unused filament can be returned within 7 days of receiving the order. For any product, a return or exchange can be requested within 3 days if there is a manufacturing defect, you received the wrong product, or it was damaged during shipping. Accessories, 3D printed items and custom orders are not returnable for change of mind. See our Return & Exchange Policy for details.',
      faq_q9: 'Can I cancel my order?',
      faq_a9: 'For 3D printed items, cancellation is possible only before production begins; once production has started, it is not available. For other orders, contact us as soon as possible.',
      faq_q10: 'Do you offer custom orders?',
      faq_a10: 'Yes. Send us your design file or a MakerWorld link, or tell us what you have in mind. All details are confirmed before production.',
      faq_q11: 'Are your products suitable as gifts?',
      faq_a11: 'Yes. Our 3D printed items are a great choice for gifts, especially for gaming enthusiasts and those who appreciate unique designs.',
      ...
      coupon_label: 'Coupon or redeem code',
      coupon_placeholder: 'Enter code',
      coupon_apply: 'Apply',
      coupon_discount_label: 'Discount',
      coupon_used: 'This code has already been used.',
      coupon_unavailable: 'Could not check the code right now. Please try again.',
      coupon_gone: 'This code is no longer available. Your total has been updated.',
      coupon_invalid: 'This code is not valid.',
      coupon_expired: 'This code has expired.',
      coupon_min: 'This code needs a minimum order of {n} SAR.',
      cart_payment_h4: 'Payment Method',
      cart_checkout_note: 'Cash on Delivery and Bank Transfer are available now.',
    ...
    ar: {
      ...
      hub_hero_h1_a: 'طابعات ثلاثية الأبعاد وطباعة حسب الطلب',
      hub_hero_h1_b: 'في السعودية',
      hub_hero_p: 'تسوّق طابعات Bambu Lab وCreality وElegoo وغيرها، أو أرسل لنا تصميمك ونطبعه لك. توصيل لجميع مناطق المملكة.',
      footer_shipping: 'سياسة الشحن',
      footer_service: 'خدمة الطباعة ثلاثية الأبعاد',
      journey_b_link: 'كيف تعمل خدمة الطباعة لدينا',
      cmp_help_h2: 'ما الذي تقارنه عند اختيار طابعة ثلاثية الأبعاد',
      cmp_help_p: 'استخدم زر المقارنة في أي طابعة داخل المتجر لعرض الطابعات جنبًا إلى جنب. هذه أهم المواصفات:',
      cmp_help_1: 'حجم الطباعة: أكبر قطعة يمكنك طباعتها دفعة واحدة.',
      cmp_help_2: 'الغرفة المغلقة: الطابعات المغلقة تحافظ على استقرار غرفة الطباعة وتناسب خامات أكثر.',
      cmp_help_3: 'أقصى حرارة للهوت إند: تحدد الخامات التي تتعامل معها الطابعة.',
      cmp_help_4: 'نظام الألوان المتعددة: مبدّلات الفلمنت مثل AMS Lite أو CFS Lite أو CANVAS، أو رؤوس طباعة مستقلة.',
      cmp_help_5: 'سرعة الطباعة والتسارع.',
      cmp_help_6: 'الخامات المدعومة وتوافق المواد.',
      cmp_help_7: 'السعر بالريال السعودي.',
      cmp_help_link1: 'تصفح الطابعات ثلاثية الأبعاد',
      cmp_help_link2: 'اقرأ: مقارنة Bambu Lab A1 وA1 mini وA2L',
      journey_b_cta2: 'تصفح الأعمال الفنية',
      journey_b_6: 'اطلب عرض سعر',
      journey_b_5: 'ديكور وأعمال فنية',
      journey_b_4: 'نماذج أولية',
      journey_b_3: 'هدايا مخصصة',
      journey_b_2: 'أرسل رابط MakerWorld',
      journey_b_1: 'أرسل ملف التصميم',
      journey_b_p: 'أخبرنا بما تحتاجه عبر واتساب. نؤكد معك جميع التفاصيل قبل بدء الإنتاج.',
      journey_b_h3: 'اطبع شيئًا بتصميمك',
      journey_a_cta2: 'تصفح كل المنتجات',
      journey_a_5: 'دعم ما بعد البيع',
      journey_a_4: 'عروض أسعار للشركات',
      journey_a_3: 'إكسسوارات',
      journey_a_2: 'فلامنت',
      journey_a_1: 'طابعات ثلاثية الأبعاد',
      journey_a_p: 'طابعات وفلامنت وإكسسوارات من Bambu Lab وCreality وElegoo وAnycubic وSnapmaker.',
      journey_a_h3: 'اشترِ معدات الطباعة ثلاثية الأبعاد',
      journeys_h2: 'كيف نساعدك؟',
      hub_explore_shop: 'تسوّق الطابعات ثلاثية الأبعاد',
      hub_ask_question: 'احصل على عرض سعر للطباعة ثلاثية الأبعاد',
      ...
      faq_a1: 'نعم. استخدم زر "احصل على عرض سعر للطباعة ثلاثية الأبعاد" أعلاه أو راسلنا عبر واتساب وسنتواصل معك مباشرة.',
      faq_q2: 'ما هي طرق الدفع المتاحة؟',
      faq_a2: 'الدفع عند الاستلام والتحويل البنكي وعرض سعر الأعمال متاحة.',
      faq_q3: 'هل المنتجات مطابقة للصور المعروضة؟',
      faq_a3: 'الطابعات والفلامنت والإكسسوارات هي منتجات الشركة المصنّعة كما تظهر وتُوصف في صفحة كل منتج. أما منتجاتنا المطبوعة ثلاثية الأبعاد (الأعمال الفنية وميدالِيات المفاتيح والهدايا) فتُصنع بالطباعة ثلاثية الأبعاد، لذا قد تلاحظ خطوط طبقات خفيفة أو اختلافات بسيطة في اللون أو الملمس. هذا أمر طبيعي يعكس عملية الطباعة وليس عيبًا.',
      faq_q4: 'هل المنتجات تستحق سعرها؟',
      faq_a4: 'الطابعات والفلامنت والإكسسوارات منتجات قياسية من الشركات المصنّعة وأسعارها بالريال، ويمكنك مقارنة الموديلات في المتجر. أما منتجاتنا المطبوعة ثلاثية الأبعاد فهي تصاميم فريدة تُنتج لدينا، وغالبًا حسب الطلب، وتمر كل قطعة بعدة مراحل من التصميم والإنتاج.',
      faq_q5: 'كم يستغرق تجهيز الطلب؟',
      faq_a5: 'تُجهَّز المنتجات المطبوعة ثلاثية الأبعاد عادةً خلال 3 إلى 5 أيام عمل، لأن معظمها يُصنع حسب الطلب. أما الطابعات والفلامنت والإكسسوارات فتظهر حالة التوفر (بما فيها الحجز المسبق) في صفحة كل منتج.',
      ...
      faq_a8: 'يمكن إرجاع الطابعات غير المستخدمة وخيوط الطباعة غير المستخدمة خلال 7 أيام من استلام الطلب. ولأي منتج، يمكن طلب الاسترجاع أو الاستبدال خلال 3 أيام في حال وجود عيب تصنيع أو استلام منتج خاطئ أو تلفه أثناء الشحن. ولا تُقبل إعادة الإكسسوارات والمنتجات المطبوعة ثلاثية الأبعاد والطلبات المخصصة لمجرد تغيير الرأي. راجع سياسة الاسترجاع والاستبدال لمزيد من التفاصيل.',
      faq_q9: 'هل يمكنني إلغاء طلبي؟',
      faq_a9: 'بالنسبة للمنتجات المطبوعة ثلاثية الأبعاد، يمكن الإلغاء فقط قبل بدء الإنتاج، وبعد بدئه لا يتوفر الإلغاء. وبالنسبة للطلبات الأخرى، تواصل معنا في أقرب وقت.',
      faq_q10: 'هل تقدمون طلبات مخصصة؟',
      faq_a10: 'نعم. أرسل لنا ملف التصميم أو رابط MakerWorld، أو أخبرنا بما تفكر فيه. تُؤكَّد جميع التفاصيل قبل بدء الإنتاج.',
      faq_q11: 'هل منتجاتكم مناسبة كهدايا؟',
      faq_a11: 'نعم. منتجاتنا المطبوعة ثلاثية الأبعاد خيار رائع للهدايا، خاصة لمحبي الألعاب ولمن يقدّر التصاميم الفريدة.',
      ...
      coupon_label: 'كوبون أو رمز الخصم',
      coupon_placeholder: 'أدخل الرمز',
      coupon_apply: 'تطبيق',
      coupon_discount_label: 'الخصم',
      coupon_used: 'تم استخدام هذا الرمز مسبقًا.',
      coupon_unavailable: 'تعذّر التحقق من الرمز حاليًا. يرجى المحاولة مرة أخرى.',
      coupon_gone: 'هذا الرمز لم يعد متاحًا. تم تحديث الإجمالي.',
      coupon_invalid: 'هذا الرمز غير صالح.',
      coupon_expired: 'انتهت صلاحية هذا الرمز.',
      coupon_min: 'يتطلب هذا الرمز حدًا أدنى للطلب قدره {n} ريال.',
      cart_payment_h4: 'طريقة الدفع',
      cart_checkout_note: 'الدفع عند الاستلام والتحويل البنكي متاحان الآن.',
